...
import { useAppContext, Table } from '../context/AppContext';// src/pages/TableStatusPage.tsx
import React, { useState, useCallback, useMemo, useEffect } from 'react';
...
export default function TableStatusPage() {
  ...
  return (
    <>
      ...
      {/* 幅ブレイクアウト＋横スクロール抑制 */}
      <div className="relative left-1/2 ml-[-50vw] w-screen overflow-x-hidden">
        {/* フィルター＆ヘッダー（sticky） */}
        <header className="sticky top-0 bg-white z-50 border-b">
          <div className="container mx-auto grid grid-cols-[1fr_auto_1fr] items-baseline px-2 py-3">
            <button
        ...
        <main
          id="main-content"
          className="px-2 py-2 grid grid-cols-3 gap-2"
        >
          {renderedTables}
        </main>
      </div>
