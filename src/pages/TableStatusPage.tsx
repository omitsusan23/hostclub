  ...
  return (
    <>
      ...
      <div className="overflow-x-hidden">
        {/* フィルター＆ヘッダー（sticky） */}
        <header className="sticky top-0 left-0 z-50 bg-white border-b">
          <div className="container mx-auto grid grid-cols-[1fr_auto_1fr] items-baseline px-4 py-5">
            <button
        ...
        {/* テーブルグリッド */}
        <main id="main-content" className="container mx-auto grid grid-cols-3 gap-2 p-4">
          {renderedTables}
        </main>
      </div>
    </>
