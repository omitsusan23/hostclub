...
export const ModalNavigation: React.FC<ModalNavigationProps> = ({ onBack, onComplete }) => {
  ...
  return (
    <nav className="fixed left-0 right-0 bg-black z-[90] flex items-center justify-between px-4" style={{ top: 'env(safe-area-inset-top)', paddingTop: '20px', paddingBottom: '20px' }}>
      <button
        onClick={onBack}
