...
interface PrincessTransitionProps {
  isAnimating: boolean;
  onComplete: () => void;
  onClose: () => void;
...
export const PrincessTransition: React.FC<PrincessTransitionProps> = ({ 
  isAnimating, 
  onComplete, 
  onClose,
  ...
  // Form fields data - Princess specific fields
  const formFields = [
    { label: '名前', placeholder: 'タップで入力' },
    { label: '電話番号', placeholder: 'タップで入力' },
    { label: 'メールアドレス', placeholder: 'タップで入力' }
  ];
